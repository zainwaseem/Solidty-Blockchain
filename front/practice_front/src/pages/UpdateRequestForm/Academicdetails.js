...
export default function Academicdetails({setActiveStep, activeStep,address,registerStudentContract,requestUpdateContract}) {
  ...
  useEffect(() => {
    fetchData();
  }, [address, registerStudentContract,requestUpdateContract]); 
